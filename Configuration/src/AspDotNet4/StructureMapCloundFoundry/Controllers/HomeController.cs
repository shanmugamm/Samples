using StructureMapCloundFoundry.ViewModels;
...
namespace StructureMapCloundFoundry.Controllers
{
    public class HomeController : Controller
    {
        ...
        private void CreateConfigServerDataViewData()
        {
            ...
            if (IConfigServerData != null && IConfigServerData.Value != null)
            {
                ...
                ViewBag.Bar = data.Message;
                ViewBag.Foo = data.Message;
                ViewBag.Info_Url = data.Message;
                ViewBag.Info_Description = data.Message;
